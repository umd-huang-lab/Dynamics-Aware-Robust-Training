...
MODELS = ['resnet18', 'resnet34', 'resnet50', 'resnet101', 
          ...
          'wrn-34-10-swish'] # 'wrn-34-10-swish' was not included in the original code


def create_model(name, normalize, info, device, GroupNorm=False):
    """
    ...
    Arguments:
        ...
        GroupNorm: replacing BN with GroupNorm
    Returns:
        torch.nn.Module.
    """
...
#         print('Using {} with GroupNorm!'.format(name))
#         backbone= ModuleValidator.fix(backbone)
#     else:
#         print('Using {} with its original normalization layer'.format(name))
    # new (with IN)
